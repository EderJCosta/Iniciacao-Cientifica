    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <c:if test="${not empty user}">
                <a class="navbar-brand" href="<c:url value="/home"/>">Biblioteca</a>
            </c:if>
        </div>
        <c:if test="${empty user}">
        ...
        <c:if test="${not empty user}">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul data-toggle="modal" data-target="#modalLogin" class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">${user.name}  <span class="glyphicon glyphicon-cog "></span></a>
