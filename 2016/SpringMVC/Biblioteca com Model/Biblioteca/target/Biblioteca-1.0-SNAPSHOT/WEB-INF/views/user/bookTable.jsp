                    ...
                    <table class="table table-hover">
                        ...
                        <c:forEach items="${bookList}" var="book" varStatus="index">
                            <tr >
                                ...
                                <td>
                                    <a class="btn btn-primary" href="<c:url value="/book/${book.id}"/>" >V</a> 
                                    <a class="btn btn-primary" href="<c:url value="/book/edit/${book.id}"/>" >E</a> 
                                    <a class="btn btn-primary" href="<c:url value="/book/delete/${book.id}"/>">X</a>     
                                </td>
                            </tr>
                        </c:forEach>
                    </table>
